...
PlanetaryPositions JPL_Eph_DE430(double Mjd_TDB) {
    ...
    // Encontrar el intervalo adecuado en PC (basado en 1)
    int i = -1;
    ...
    // Segmento adicional para la Tierra
    for (int k = 0; k < 3; ++k) {
        temp[k] += 39;
    }
    ...
    std::cout << "[OK] Cx_Earth columnas final = " << Cx_Earth.getColumnas() << std::endl;
    ...
    positions.r_Earth = Cheb3D(Mjd_TDB, 13, Mjd0, Mjd0+16,
                               Cx_Earth.getSubMatrix(1, 1, 13*j+1, 13*(j+1)),
                               Cy_Earth.getSubMatrix(1, 1, 13*j+1, 13*(j+1)),
                               Cz_Earth.getSubMatrix(1, 1, 13*j+1, 13*(j+1))) * 1e3;
    ...
    positions.r_Moon = Cheb3D(Mjd_TDB, 13, Mjd0, Mjd0+4,
                              Cx_Moon.getSubMatrix(1, 1, 13*j+1, 13*(j+1)),
                              Cy_Moon.getSubMatrix(1, 1, 13*j+1, 13*(j+1)),
                              Cz_Moon.getSubMatrix(1, 1, 13*j+1, 13*(j+1))) * 1e3;
    ...
    positions.r_Sun = Cheb3D(Mjd_TDB, 11, Mjd0, Mjd0+16,
                             Cx_Sun.getSubMatrix(1, 1, 11*j+1, 11*(j+1)),
                             Cy_Sun.getSubMatrix(1, 1, 11*j+1, 11*(j+1)),
                             Cz_Sun.getSubMatrix(1, 1, 11*j+1, 11*(j+1))) * 1e3;
    ...
    positions.r_Mercury = Cheb3D(Mjd_TDB, 14, Mjd0, Mjd0+8,
                                 Cx_Mercury.getSubMatrix(1, 1, 14*j+1, 14*(j+1)),
                                 Cy_Mercury.getSubMatrix(1, 1, 14*j+1, 14*(j+1)),
                                 Cz_Mercury.getSubMatrix(1, 1, 14*j+1, 14*(j+1))) * 1e3;
    ...
    positions.r_Venus = Cheb3D(Mjd_TDB, 10, Mjd0, Mjd0+16,
                               Cx_Venus.getSubMatrix(1, 1, 10*j+1, 10*(j+1)),
                               Cy_Venus.getSubMatrix(1, 1, 10*j+1, 10*(j+1)),
                               Cz_Venus.getSubMatrix(1, 1, 10*j+1, 10*(j+1))) * 1e3;
    ...
    positions.r_Mercury = -1.0*positions.r_Earth + positions.r_Mercury;
    positions.r_Venus = -1.0*positions.r_Earth + positions.r_Venus;
    positions.r_Mars = -1.0*positions.r_Earth + positions.r_Mars;
    positions.r_Jupiter = -1.0*positions.r_Earth + positions.r_Jupiter;
    positions.r_Saturn = -1.0*positions.r_Earth + positions.r_Saturn;
    positions.r_Uranus = -1.0*positions.r_Earth + positions.r_Uranus;
    positions.r_Neptune = -1.0*positions.r_Earth + positions.r_Neptune;
    positions.r_Pluto = -1.0*positions.r_Earth + positions.r_Pluto;
    positions.r_Sun = -1.0*positions.r_Earth + positions.r_Sun;
