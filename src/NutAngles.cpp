...
struct NutCoeff {
    int l, lp, F, D, Om;
    double dpsi0, dpsi1, deps0, deps1;
};

// Coeficientes de nutación IAU 1980
const std::vector<NutCoeff> C = {
